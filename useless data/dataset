...
df_data.to_csv('data4.csv', index = False, header = False)
...
X_train.to_csv('X_train3.csv', index = False, header = False)
X_test.to_csv('X_test3.csv', index = False, header = False)
y_train.to_csv('y_train3.csv', index = False, header = False)
y_test.to_csv('y_test3.csv', index = False, header = False)
